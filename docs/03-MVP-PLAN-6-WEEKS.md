...
- [ ] React Router: `/`, `/orders`, `/clients`, `/carriers`
- [ ] UI-kit: таблица, форма, кнопки, badge статусов
- [ ] API client (fetch/axios)

### День 2–3: Справочники
- [ ] Страница клиентов: список + модалка создания
- [ ] Страница перевозчиков
- [ ] Страница ТС с привязкой к перевозчику

### День 4–5: Заказы
- [ ] Список заказов с фильтрами
- [ ] Карточка заказа: форма + назначение перевозчика
- [ ] Смена статуса (dropdown + confirm)
- [ ] Отображение маржи
